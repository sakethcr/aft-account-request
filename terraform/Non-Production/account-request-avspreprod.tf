module "account_request_avs_preprod" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "saketh.chodimella.avspreprod@panaceatechsolutions.com"
    AccountName               = "avs-preprod-account"
